    ...
    return (
        <div className="profileFeed">
            <div className="profileFeedContainer">
                <div style={{fontSize:'31px',fontWeight:'600',color:'#808080'}}>Welcome Back</div>
                ...
                <div id="PFpoints">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill="#ffaf11" className="bi bi-award-fill" viewBox="0 0 16 16">
                    <path d="M8 0l1.669.864 1.858.282.842 1.68 1.337 1.32L13.4 6l.306 1.854-1.337 1.32-.842 1.68-1.858.282L8 12l-1.669-.864-1.858-.282-.842-1.68-1.337-1.32L2.6 6l-.306-1.854 1.337-1.32.842-1.68L6.331.864 8 0z"/>
                    <path d="M4 11.794V16l4-1 4 1v-4.206l-2.018.306L8 13.126 6.018 12.1 4 11.794z"/>
                    </svg>
                    <div style={{margin:'1px 0px 0px 10px',fontSize:'20px'}}>{user.points} Points</div>
                </div>
